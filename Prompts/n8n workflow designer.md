...
Copy the prompt below, paste it into any LLM, and describe the process you want to automate. Be as specific as possible about what happens today — who does what, in what order, using which tools.
